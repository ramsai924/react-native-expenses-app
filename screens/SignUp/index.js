...
const Signup = ({ navigation }) => {
    ...
    const onSubmit = async () => {
        try {
            ...
            const response = await authenticate('signUp', { email: authForm.email.value?.toLowerCase(), password: authForm.password.value })
            if(response){
        ...
        <KeyboardAvoidingView
            ...
            <View style={styles.container}>
                    <View style={styles.form}>
                        ...
                        }}>Click here to <Text style={styles.alertBold}>Sign In</Text></Text>
                    </View>
            </View>
        </KeyboardAvoidingView>
    </ScrollView>
